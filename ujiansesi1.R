# Jawaban nomor 1
nomor1 = c(150, 160, 170, 180, 152, 162, 172, 182, 154, 174, 155, 165, 175, 185, 176, 157, 167, 187, 178, 169)
# mengurutkan data
sort1 = sort(nomor1)
sort1
# jumlah data
...
# Jawaban nomor 2
nomor2 = c(22,25, 27, 30, 35, 32, 28, 26, 29, 33, 31, 34, 27, 25, 29, 28, 30, 32, 31, 33)
sort2 = sort(nomor2)
sort2
# Mean data tunggal
mean(sort2)
...
# Jawaban nomor 3
nomor3 = data.frame(
	Kelas = c("51-55", "56-60", "61-65", "66-70", "71-75", "76-80"),
	Frekuensi = c(3, 4, 8, 7, 2, 6),
	Titik_tengah = c(53, 58, 63, 68, 73, 78)
)
nomor3
